...
-- species table
CREATE TABLE `idealcrop`.`species` ( `id` INT NOT NULL , `speicies_name` VARCHAR(64) NOT NULL , `crop` INT NOT NULL , `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , `updated_at` TIMESTAMP on update CURRENT_TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , `created_by` INT NOT NULL , `last_updated_by` INT NOT NULL, PRIMARY KEY (`id`))  ENGINE = InnoDB;
...
-- variety table
CREATE TABLE `idealcrop`.`variety` ( `id` INT(20) NOT NULL AUTO_INCREMENT , `species` INT NOT NULL , `variety_name` VARCHAR(64) NOT NULL , `year` YEAR NOT NULL , `owner` VARCHAR(64) NOT NULL , `maintainer` VARCHAR(64) NOT NULL , `optimal_production_altitude` VARCHAR(64) NOT NULL , `maturity_duration` INT NOT NULL , `yield` VARCHAR(64) NOT NULL , `special_attributes` VARCHAR(255) NOT NULL , `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , `updated_at` TIMESTAMP on update CURRENT_TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , `created_by` INT NOT NULL , `last_updated_by` INT NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
...
-- practice table
CREATE TABLE `idealcrop`.`practice` ( `id` INT NOT NULL , `practice_name` VARCHAR(255) NOT NULL , `practice_description` VARCHAR(255) NOT NULL , `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , `updated_at` TIMESTAMP on update CURRENT_TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , `created_by` INT NOT NULL , `last_updated_by` INT NOT NULL, PRIMARY KEY  (`id`)) ENGINE = InnoDB;
